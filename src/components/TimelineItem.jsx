  ...
  return (
    <ol className="flex flex-col md:flex-row relative border-l border-stone-400 dark:border-stone-600">
      <li className="mb0-10 ml-4">
        <div className="absolute w-3 h-3 bg-stone-500 rounded-full mt-1.5 -left-1.5 border border-stone-800 dark:border-stone-200" />
        ...
        <p className="my-2 text-base font-normal text-stone-800 dark:text-stone-400">
          {details}
        </p>
      </li>
    </ol>
